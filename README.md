...
- [ ] The way people meet, communicate, and build relationships is evolving rapidly. Technology has transformed how we connect—but there is still enormous opportunity to create platforms that are safer, more inclusive, more authentic, and better suited to the needs of African communities.

This hackathon invites developers, designers, product builders, and innovators to rethink the future of dating and social networking. Participants will collaborate to build digital experiences that foster meaningful human connections while addressing challenges such as trust, privacy, safety, accessibility, and community engagement.
